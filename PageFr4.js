...
class PageFr4 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      categes: [
        { cat_id: '1', cat_name: 'Sexisme', backgroundcolor: '#E6E6E6', val:"Sexisme" },
        { cat_id: '2', cat_name: 'Racisme et Régionalisme', backgroundcolor: '#E6E6E6' , val:"Racisme et Régionalisme"},
        { cat_id: '3', cat_name: 'Classe sociale', backgroundcolor: '#E6E6E6', val:"Classe sociale" },
...
this.props.navigation.navigate('PageFr5')
}
  ...
  return (
    <View style={styles.container}>
      ...
      >
           <TouchableOpacity onPress={() =>{this.props.navigation.navigate('PageFr3')}}>
