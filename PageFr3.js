...
class PageFr3 extends Component {
  state={
...
CheckTextInput = () => {
  ...
  if (this.state.name == ''){
    ...
    this.nameValidate=false;
                this.setState({
      errorname :  
      "Le champ de nom ne doit contenir que des lettres!"
    });
    }
  ...
  if (this.state.url == ''){
    ...
    this.urlValidate=false;
    this.setState({
      errorurl :"Ce champ doit être une autre façon!"
    });
    }
    ...
    if (
      ...
      this.nameValidate &&
      this.urlValidate ) {
        this.props.navigation.navigate('PageFr4',{
...
>Remplir les champs suivants:</Text>
<Text style={styles.urlDuSite}>Nom du Site</Text>
      ...
      <Text style={styles.nomDuSite}>Url du Site</Text>
