...
class PageFr5 extends Component {
  ...
  upload_button = () => {
    ...
    this.upload_firebase(this.state.image,Date.now())
      .then(()=>{
        Alert.alert("Succès!");
        this.props.navigation.navigate('PageFr7'); 
      }).catch((error)=>{
        Alert.alert("veuillez d'abord choisir la photo!");
      });
  }
  ...
  render() {
        ...
        <View style={styles.container}>
          <View style={styles.question2StackStack}>
            <View style={styles.question2Stack}>
              <Text style={styles.question2}>Prenez une photo ou téléchargez.</Text>
              <ImageBackground
              ...
              >
            <TouchableOpacity onPress={() =>{this.props.navigation.navigate('PageFr4')}}>
    <Icons name={'arrow-back'}  color='#fff'  style={styles.icon1} />
           ...
           <EntypoIcon name="camera" style={styles.icon2}
             onPress={() =>{this.props.navigation.navigate('CamFr')}}
            ></EntypoIcon>
          
          </View>
          <View style={styles.uploadRow}>
         
            <Text style={styles.upload}>Télécharger</Text>
            
            <Text style={styles.camera}>Caméra</Text>
            <Text style={styles.orTapHere}  onPress={()=>this._pickImage()} >ou appuyez ici</Text>
          </View>
